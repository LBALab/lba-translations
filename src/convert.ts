...
msgstr ""\n`);
        ...
        pot = pot.concat(`Language-Team: ${language.name} <https://translations.scummvm.org/projects/twin-e/twin-e/${language.culture}/>\n`);
...
msgstr ""\n`);
        ...
        po = po.concat(`Language-Team: ${language.name} <https://translations.scummvm.org/projects/twin-e/twin-e/${language.culture}/>\n`);
